...
global.nameown = 'SANS-OWNER'

/*============== Github Thanks To ==============*/
global.namagithub = 'Ivanwagu' // nama github lu
global.linkgithub = 'https://github.com/Ivanwagu' // tarok link github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6285876830674', 'SANS DEV', true],
  ['6285809011357', 'SANS DEV', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.wm = '                「 SANS-BOT」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘SANS-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ SANS-BOT ⫹⫺'
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By SANS-DEV`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 SANS-BOT-V1  あ」'
